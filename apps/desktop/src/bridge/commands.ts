...
// ── 插件视图 ──
export const openPluginView = (pluginId: string, commandId: string) =>
  invokeCore<import('@litools/sdk').PluginViewInfo>('open_plugin_view', { pluginId, commandId });
export const hidePluginView = (pluginId: string, commandId: string) =>
  invokeCore<import('@litools/sdk').PluginViewInfo>('hide_plugin_view', { pluginId, commandId });
export const detachPluginView = (pluginId: string, commandId: string) =>
  invokeCore<import('@litools/sdk').PluginViewInfo>('detach_plugin_view', { pluginId, commandId });
export const closePluginView = (pluginId: string, commandId: string) =>
  invokeCore<void>('close_plugin_view', { pluginId, commandId });
export const closePluginViewById = (runtimeId: string) =>
  invokeCore<void>('close_plugin_view_by_id', { runtimeId });
export const getPluginViewInfo = (runtimeId: string) =>
  invokeCore<import('@litools/sdk').PluginViewInfo>('get_plugin_view_info', { runtimeId });
...
export const openPluginDevtools = (runtimeId: string) =>
  invokeCore<void>('open_plugin_devtools', { runtimeId });
...
export const togglePlugin = (pluginId: string, enabled: boolean) =>
  invokeCore<import('@litools/sdk').PluginSummary>('toggle_plugin', { pluginId, enabled });
export const installPlugin = (filePath: string) =>
  invokeCore<import('@litools/sdk').PluginSummary>('install_plugin', { filePath });
export const uninstallPlugin = (pluginId: string) =>
  invokeCore<void>('uninstall_plugin', { pluginId });

// ── 设置 & 索引 ──
export const getSettings = () => invokeCore<import('@litools/sdk').AppSettings>('get_settings');
export const updateSettings = (settings: import('@litools/sdk').AppSettings) =>
  invokeCore<import('@litools/sdk').AppSettings>('update_settings', { settings });

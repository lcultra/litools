...
pub use manager::{InstalledPlugin, PluginCommandSearchItem, PluginManager, PluginSource};
pub use manifest::{
    PluginCommand, PluginCommandMode, PluginDevelopment, PluginManifest, RuntimePolicy,
    plugin_command_mode_from_str,
};
